...
const AdminSidebar = () => {
  const menuItems = [
    ...
    { icon: Database, label: 'Verifications (Under 18)', path: '/admin/dashboard/verifications' },
    { icon: User, label: 'Users', path: '/admin/dashboard/users' },
    { icon: LifeBuoy, label: 'Payments', path: '/admin/dashboard/payments' },
    { icon: Bell, label: 'Support', path: '/admin/dashboard/support' },
  ];
