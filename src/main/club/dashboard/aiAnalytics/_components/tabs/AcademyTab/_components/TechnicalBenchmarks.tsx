interface TechnicalBenchmarksProps {
  data?: Array<{
    metric: string;
    target: string;
  }>;
...
const TechnicalBenchmarks = ({ data }: TechnicalBenchmarksProps) => {
  if (!data) return null;

  return (
    <div className="bg-[#12141B] p-6 rounded-xl border border-white/5 h-full">
      <h2 className="text-base font-bold text-white mb-6 tracking-tight">Technical Benchmarks</h2>
