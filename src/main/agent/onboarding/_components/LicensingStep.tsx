    ...
    <div className="w-full max-w-4xl bg-[#11161D]">
      ...
      <div className="flex justify-between mt-8">
        <Button
          onClick={onBack}
          variant="outline"
          className="border-slate-600 text-gray-400 bg-transparent px-6 h-11 rounded-xl cursor-pointer hover:bg-[#53DDF5]/90 "
        >
          &lt; Back
        </Button>
        <Button
          onClick={onNext}
          className="bg-[#53DDF5] hover:bg-[#53DDF5]/90 text-slate-950 font-medium px-8 h-11 rounded-xl cursor-pointer"
        >
          Continue &gt;
        </Button>
      </div>
