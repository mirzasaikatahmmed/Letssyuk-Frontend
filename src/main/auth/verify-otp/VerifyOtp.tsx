                ...
                <FormControl>
                  <InputOTP maxLength={6} {...field} className="gap-2">
                    <InputOTPGroup className="gap-1 sm:gap-2">
                      <InputOTPSlot
                        index={0}
                        className="size-10 sm:size-12 md:size-14 text-lg md:text-xl rounded-xl border-[#1B314B] bg-[#0F172A]/60 text-white focus-visible:ring-1 focus-visible:ring-[#00E5FF]"
                      />
                      <InputOTPSlot
                        index={1}
                        className="size-10 sm:size-12 md:size-14 text-lg md:text-xl rounded-xl border-[#1B314B] bg-[#0F172A]/60 text-white"
                      />
                      <InputOTPSlot
                        index={2}
                        className="size-10 sm:size-12 md:size-14 text-lg md:text-xl rounded-xl border-[#1B314B] bg-[#0F172A]/60 text-white"
