...
const ConsentDeclarations = () => {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    alert(
      "Onboarding Complete! Check the browser console (F12) to see all form data.",
    );
  };
      ...
      >
        ...
        <div className="flex gap-3 bg-[#0d1e21] border border-cyan-900/30 p-4 rounded-xl items-start">
          ...
          <div>
            ...
            <p className="text-cyan-100/60 text-[11px] leading-relaxed">
              ...
              your profile and access AI career intelligence.
            </p>
          </div>
        </div>
          ...
          {sections.map((section) => {
            ...
            return (
              <div
                ...
                onClick={() =>
                  setValue(section.id as keyof FormValues, !isChecked, {
                    shouldValidate: true,
                  })
                }
                className={`flex gap-4 p-6 rounded-2xl border transition-all cursor-pointer select-none ${
                  isChecked
                ...
                <div className="mt-1" onClick={(e) => e.stopPropagation()}>
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setValue(section.id as keyof FormValues, !!checked, {
                        shouldValidate: true,
                      })
                    }
        ...
        <div className="flex justify-between items-center mt-12 pt-4">
          ...
          <Button
            ...
            className={`flex items-center gap-2 px-10 h-11 rounded-xl transition-all text-sm font-medium shadow-lg cursor-pointer ${
              isValid
